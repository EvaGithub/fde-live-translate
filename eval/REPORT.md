...
- Benchmark: hit p95 `5 ms`, miss p95 `0 ms`, hit rate `100%`, throughput `2872 rps`, SLA **PASS**
...
── SLA GATE ────────────────────────────────────────
    ...
    PASS  min_throughput_rps       2872.2 >= 20

✅ ALL SLAs MET

Wrote /Users/evalb/FDE . Assigment 1/eval/_bench.json
```
</details>
